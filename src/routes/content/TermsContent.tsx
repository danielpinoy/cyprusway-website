 ...
 * Prose ported verbatim from `main:terms.html`. English only, as it was
...
export function TermsContent() {
  return (
    <div className={styles.prose}>
      ...
      <p>CyprusWay provides a mobile travel companion app and marketing website that help users discover curated places across Cyprus, preview them through 360° virtual tours, plan personalised trip itineraries, ask travel questions, and connect to third-party booking providers for hotels, car rental, activities, and transfers.</p>
